...
package api
// SetFailoverGracePeriodData struct for SetFailoverGracePeriodData
type SetFailoverGracePeriodData struct {
	// The node's desired failover grace period in milliseconds.  
	GracePeriod uint64 `json:"gracePeriod,omitempty"`
