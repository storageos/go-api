...
func (a *DefaultApiService) AddDeploymentOnNode(ctx _context.Context, namespaceID string, id string, addDeploymentOnNodeData AddDeploymentOnNodeData, localVarOptionals *AddDeploymentOnNodeOpts) (AcceptedMessage, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/namespaces/{namespaceID}/volumes/{id}/add-deployment-on-node"
	...
	// body params
	localVarPostBody = &addDeploymentOnNodeData
...
/*
AttemptPromotion Attempt a promotion of a replica to a master
...
func (a *DefaultApiService) AttemptPromotion(ctx _context.Context, namespaceID string, id string, deploymentID string) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/namespaces/{namespaceID}/volumes/{id}/debug/attempt-replica-promotion/{deploymentID}"
	localVarPath = strings.Replace(localVarPath, "{"+"namespaceID"+"}", _neturl.QueryEscape(parameterToString(namespaceID, "")) , -1)
...
func (a *DefaultApiService) CreatePool(ctx _context.Context, createPoolData CreatePoolData) (Pool, *_nethttp.Response, error) {
	...
	// body params
	localVarPostBody = &createPoolData
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (a *DefaultApiService) DeletePool(ctx _context.Context, id string, version string, localVarOptionals *DeletePoolOpts) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/pools/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")) , -1)
...
func (a *DefaultApiService) EvictReplica(ctx _context.Context, namespaceID string, id string, deploymentID string) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/namespaces/{namespaceID}/volumes/{id}/debug/evict/{deploymentID}"
	localVarPath = strings.Replace(localVarPath, "{"+"namespaceID"+"}", _neturl.QueryEscape(parameterToString(namespaceID, "")) , -1)
...
/*
GetPool Fetch a Pool
Fetch the pool identified by id.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id ID of a Pool
@return Pool
*/
func (a *DefaultApiService) GetPool(ctx _context.Context, id string) (Pool, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *DefaultApiService) GetSingleNodeDiagnostics(ctx _context.Context, id string) (*os.File, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/diagnostics/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")) , -1)
...
/*
ListPools Fetch the list of pools
...
func (a *DefaultApiService) SetComputeOnly(ctx _context.Context, id string, setComputeOnlyNodeData SetComputeOnlyNodeData, localVarOptionals *SetComputeOnlyOpts) (Node, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/nodes/{id}/compute-only"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")) , -1)
	...
	// body params
	localVarPostBody = &setComputeOnlyNodeData
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (a *DefaultApiService) SetCordoned(ctx _context.Context, id string, setCordonedNodeData SetCordonedNodeData, localVarOptionals *SetCordonedOpts) (Node, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/nodes/{id}/cordon"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")) , -1)
	...
	// body params
	localVarPostBody = &setCordonedNodeData
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
// SetFailoverGracePeriodOpts Optional parameters for the method 'SetFailoverGracePeriod'
type SetFailoverGracePeriodOpts struct {
    IgnoreVersion optional.Bool
}

/*
SetFailoverGracePeriod Modify the failover grace period for a node
Set the failover grace period for the node corresponding  to id given by the request. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id ID of a Node
 * @param setFailoverGracePeriodData
 * @param optional nil or *SetFailoverGracePeriodOpts - Optional Parameters:
 * @param "IgnoreVersion" (optional.Bool) -  If set to true this value indicates that the user wants to ignore entity version constraints, thereby \"forcing\" the operation. 
@return Node
*/
func (a *DefaultApiService) SetFailoverGracePeriod(ctx _context.Context, id string, setFailoverGracePeriodData SetFailoverGracePeriodData, localVarOptionals *SetFailoverGracePeriodOpts) (Node, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/nodes/{id}/failover-grace-period"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")) , -1)
	...
	// body params
	localVarPostBody = &setFailoverGracePeriodData
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (a *DefaultApiService) SetFailureMode(ctx _context.Context, namespaceID string, id string, setFailureModeRequest SetFailureModeRequest, localVarOptionals *SetFailureModeOpts) (Volume, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/namespaces/{namespaceID}/volumes/{id}/failure-mode"
	localVarPath = strings.Replace(localVarPath, "{"+"namespaceID"+"}", _neturl.QueryEscape(parameterToString(namespaceID, "")) , -1)
	...
	// body params
	localVarPostBody = &setFailureModeRequest
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (a *DefaultApiService) SetPlacementStrategy(ctx _context.Context, namespaceID string, id string, setPlacementStrategyData SetPlacementStrategyData, localVarOptionals *SetPlacementStrategyOpts) (AcceptedMessage, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/namespaces/{namespaceID}/volumes/{id}/placement-strategy"
	localVarPath = strings.Replace(localVarPath, "{"+"namespaceID"+"}", _neturl.QueryEscape(parameterToString(namespaceID, "")) , -1)
	...
	// body params
	localVarPostBody = &setPlacementStrategyData
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
/*
SetPreferredEvictionCandidates Specifies a list of deployments to be preferred to be evicted.
...
func (a *DefaultApiService) SetPreferredEvictionCandidates(ctx _context.Context, namespaceID string, id string, setPreferredEvictionCandidatesData SetPreferredEvictionCandidatesData, localVarOptionals *SetPreferredEvictionCandidatesOpts) (AcceptedMessage, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/namespaces/{namespaceID}/volumes/{id}/preferred-eviction-candidates"
	localVarPath = strings.Replace(localVarPath, "{"+"namespaceID"+"}", _neturl.QueryEscape(parameterToString(namespaceID, "")) , -1)
	...
	// body params
	localVarPostBody = &setPreferredEvictionCandidatesData
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (a *DefaultApiService) UpdatePool(ctx _context.Context, id string, updatePoolData UpdatePoolData, localVarOptionals *UpdatePoolOpts) (Pool, *_nethttp.Response, error) {
	...
	// body params
	localVarPostBody = &updatePoolData
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
