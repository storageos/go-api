...
**TopologyLabels** | [**TopologyLabels**](TopologyLabels.md) |  | [optional] 
...
**SnapshotConfig** | [**map[string]Snapshot**](Snapshot.md) |  | [optional] 
**SnapshotVolumes** | [**map[string]SnapshotVolume**](SnapshotVolume.md) |  | [optional] 
