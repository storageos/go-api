...
**DisableVersionCheck** | **bool** | Disables the mechanism responsible for checking if there is an updated version of Ondat available for installation.  | [optional] [default to false]
